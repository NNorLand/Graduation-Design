...
<body>
	...
	//百度地图API功能
		...
		map.centerAndZoom(new BMap.Point(114.282, 35.233), 6);


        var point1=new BMap.Point(114.281713, 30.234134);//创建坐标
        var point2=new BMap.Point(114.250682, 38.230392);//创建坐标
        var point3=new BMap.Point(114.283868, 40.210959);//创建坐标
