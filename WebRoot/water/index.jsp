...
<body>
        ...
        <div class="moreblock">
            ...
            <div class="more_content">
                ...
                <div class="spot2">路面温度信息<img id='spot22' src='wind.png' width=290 height=200 border=0/>说明：<br>水温历史信息</div>
	...
	<script type="text/javascript">
		...
		map.centerAndZoom(new BMap.Point(115.282, 37.233), 13);

		var point1=new BMap.Point(115.281713, 37.234134);//创建坐标
		var point2=new BMap.Point(115.250682, 37.230392);//创建坐标
		var point3=new BMap.Point(115.283868, 37.210959);//创建坐标
	...
	;(function(){
		...
		var sContent ="<p class='content'>经度:"+contents[0].lng+"&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp纬度:"+contents[0].lat+
					...
					"<input type=button value='路面温度' id=btn_test2 onclick=getJFreeChar2()>"+
		...
		//坐标点实时信息
		var ajax,ajax1,ajax2,ajax3,ajax4,ajax5,ajax6,ajax00,ajax11,ajax22,ajax33,ajax44,ajax55,ajax66,i1=i2=i3=i4=i5=i6=i7=0;
							...
							events: {
								load: function() {
									...
									setInterval(function() {
										...
										var x = (new Date()).getTime(), // current time
											y = ajax66;//Math.random()*100+Math.random()*10+3700;
										if(i>3){
											y = ajax;
										}
										series.addPoint([x, y], true, true);
...
//			});
			...
			//实时
			$.post('../tem_gas',{index:i},function(ajaxdata){
				ajax00=ajaxdata.data;
		    },"json");
			$.post('../tem_water',{index:i},function(ajaxdata){
				ajax11=ajaxdata.data;
		    },"json");
			$.post('../hum',{index:i},function(ajaxdata){
				ajax22=ajaxdata.data;
		    },"json");
//			$.post('../water_line',{index:i},function(ajaxdata){
//				ajax33=ajaxdata.data;
//		    },"json");
			$.post('../somke',{index:i},function(ajaxdata){
				ajax44=ajaxdata.data;
		    },"json");
			$.post('../atmos',{index:i},function(ajaxdata){
				ajax55=ajaxdata.data;
		    },"json");
			$.post('../prec',{index:i},function(ajaxdata){
				ajax66=ajaxdata.data;
		    },"json");
